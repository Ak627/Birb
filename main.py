...
Birb = pygame.image.load('birb.png') #load your spritesheet
Birb.set_colorkey((255, 0, 255)) #this makes bright pink (255, 0, 255) transparent (sort of)
...
while not gameover:
    ...
    screen.blit(Birb, (xpos, ypos), (frameWidth*frameNum, RowNum*frameHeight, frameWidth, frameHeight))
    pygame.draw.rect(screen, (0, 130, 50), (0, 706, 800, 500))
